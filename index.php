...
<a href="feedback.php" style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new"></a></div>
...
<div class="form-group" align="center">
<input type="submit" name="reg" value="reg" class="btn btn-primary" />
</div>
</form>
